#!/usr/bin/env python3
"""Dodaj TikTok komentare na annotation CSV (polu-rucno, bez scrapinga)."""
...
from src.dataset.append_tiktok import append_tiktok_comments
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Otvara TikTok URL u browseru i dopisuje komentare koje TI rucno "
            "kopiras (ToS: nema automatskog scrapinga)."
        )
    )
